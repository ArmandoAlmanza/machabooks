        ...
        <div className="w-full">
            <form className="max-w-md mx-auto">
                <fieldset className="border border-white p-4 w-full">
                    <legend>Machabooks Register</legend>
                    ...
                    <div className="flex flex-col gap-3 md:gap-0 justify-between items-center md:flex-row">
                        ...
                        <Button
                            onClick={() => {
                                setUser({ ...user, id: crypto.randomUUID() });
                                console.log(user);
                            }}
                            className="px-5 py-1.5 focus:ring-4 focus:outline-none focus:ring-black hover:text-black hover:bg-blue-200 transition-colors duration-300"
                        >
                            <span>Submit</span>
                        </Button>
                    </div>

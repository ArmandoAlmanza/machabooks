...
const BookList = () => {
    const books = [
        {
            sku: "f9d1a2e3-4c5b-6789-0123-456789abcdef",
        ...
        {
            sku: "a1b2c3d4-5e6f-7890-1234-56789abcdef0",
        ...
        {
            sku: "12345678-90ab-cdef-1234-567890abcdef",
        ...
        {
            sku: "abcdef12-3456-7890-abcd-ef1234567890",
            title: "Warbreaker",
            stock: 20,
            genres: ["Fantasy", "Novel"],
            author: {
        ...
        {
            sku: "1234abcd-5678-90ef-1234-567890abcdef",
        ...
        {
            sku: "abcd1234-5678-90ef-1234-567890abcdef",
        ...
        {
            sku: "5678abcd-1234-5678-90ef-1234567890ab",
            title: "Oathbringer",
            stock: 9,
            genres: ["Fantasy", "Novel"],
            author: {
        ...
        {
            sku: "90ef1234-5678-90ab-cdef-1234567890ab",
            title: "Rhythm of War",
            stock: 24,
            genres: ["Fantasy", "Novel"],
            author: {
        ...
        {
            sku: "5678ef90-1234-5678-90ab-cdef12345678",
            title: "Elantris",
            stock: 7,
            genres: ["Fantasy", "Novel"],
            author: {
